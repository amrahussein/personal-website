  ...
  return (
    <div className='space-y-4'>
      ...
      <p>
        ...
        knowing people online, playing games esp soccer games and <em>Technology</em>, for sure, has been a great part of my life since childhood for it&apos;s impact.
      </p>
      ...
      <p>
        <em>The internet,</em> to me, was a chance to learn a lot about the world. I was
      ...
      <p>
        ...
        believe the world of DEV embraces that where I want to grow and
        contribute.</strong>
      </p>
    </div>
  )
