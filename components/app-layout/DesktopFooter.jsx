...
export default function DesktopFooter() {
  return (
    <footer className='fixed inset-x-0 bottom-0 flex items-center justify-between border-4 border-x-0 border-b-0 border-solid border-accent bg-white px-10 pb-6 pt-2'>
      <Copyright />
