export const aboutLandingInfo = {
  ...
  inspiringThings: [
    'Latest technologies on Github that make it easier to create & maintain web applications',
    'Various DEV communities that focus on the quality of the software',
    'UX works through diverse channels that simplify & enhance the user experience',
  ],
};
